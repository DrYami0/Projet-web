...
<head>
    ...
    <title>Utilisateurs en attente - Admin</title>
        ...
        <aside class="sidebar" id="sidebar">
            ...
            <nav class="sidebar-nav">
                ...
                <div class="nav-section">
                    ...
                    <a href="<?=BASE_URL?>PerFranMVC/Controller/admin.php?action=pending" class="nav-link active">
            ...
            <div class="content-area">
                ...
                <div class="stats-grid" style="grid-template-columns: repeat(2, 1fr); max-width: 600px;">
                    ...
                    <div class="stat-card primary">
                        ...
                        <div class="stat-label">Délai d'expiration</div>
                    </div>
                </div>
                ...
                <div class="table-card">
                    <div class="table-header">
                        <h3 class="table-title">Demandes d'inscription (<?=$pendingCount?>)</h3>
                    </div>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <div class="action-buttons" style="gap: 8px;">
                                                    <a href="<?=BASE_URL?>PerFranMVC/Controller/admin.php?action=approve_user&username=<?=urlencode($p['username'])?>" class="btn btn-success btn-sm">
                                                        <i class="fas fa-check"></i> Approuver
                                                    </a>
                                                    <a href="<?=BASE_URL?>PerFranMVC/Controller/admin.php?action=reject_user&username=<?=urlencode($p['username'])?>" class="btn btn-danger btn-sm" onclick="return confirm('Refuser et supprimer cette demande ?')">
