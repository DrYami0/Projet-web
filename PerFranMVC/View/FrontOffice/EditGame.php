...
require_once "../../PerFranMVC/Model/Game.php";
...
$gid = $_GET['gid'] ?? null;
if (!$gid) {
    header('Location: ' . BASE_URL . 'PerFranMVC/View/FrontOffice/DisplayGames.php');
    exit();
}
...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    if ($gameC->editGame($gameObj, $gid, $_SESSION['user_id'], $is_admin)) {
        header("Location: " . ($is_admin ? "DisplayGamesAdmin.php" : "/projet-web/index.php") . "?message=Game updated successfully");
    } else {
        ...
        <section class="form-section">
            ...
            <form method="POST" class="game-form">
                ...
                <div class="form-actions">
                    ...
                    <a href="<?php echo $is_admin ? 'DisplayGamesAdmin.php' : '/projet-web/index.php'; ?>" class="btn secondary">Annuler</a>
                </div>
            </form>
        </section>
    </main>
