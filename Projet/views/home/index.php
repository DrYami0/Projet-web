					...
					<div class="container">
						...
						<div class="collapse navbar-collapse offset" id="navbarSupportedContent">
							<ul class="nav navbar-nav menu_nav ml-auto">
								<li class="nav-item active"><a class="nav-link" href="<?php echo BASE_URL; ?>">Accueil</a></li> 
								<li class="nav-item"><a class="nav-link" href="#">About</a></li> 
								<li class="nav-item submenu dropdown">
									<a href="#" class="nav-link dropdown-toggle" data-toggle="dropdown" role="button" aria-haspopup="true" aria-expanded="false">Cours</a>
								...
								<li class="nav-item"><a class="nav-link" href="<?php echo BASE_URL; ?>game">Jeu</a></li>
            ...
            <div class="banner_inner d-flex align-items-center">
				...
				<div class="container">
					<div class="banner_content text-center">
						<h3>Nous garantissons une meilleure éducation <br />pour un avenir meilleur</h3>
						<p>Assurer une éducation de qualité pour construire demain.</p>
						<a class="main_btn" href="<?php echo BASE_URL; ?>game">commencer</a>
					</div>
				</div>
            </div>
        </section>
        		...
        		<div class="row courses_inner">
						...
						<div class="grid_inner">
							<div class="grid_item wd55">
								<div class="courses_item">
									<img src="<?php echo BASE_URL; ?>assets/img/courses/course-1.jpg" alt="">
									<div class="hover_text">
										<a class="cat" href="#">Free</a>
										<a href="#"><h4>Mode Multijoueur</h4></a>
										<ul class="list">
							...
							<div class="grid_item wd44">
								<div class="courses_item">
									<img src="<?php echo BASE_URL; ?>assets/img/courses/course-2.jpg" alt="">
									<div class="hover_text">
										<a class="cat" href="#">Free</a>
							...
							<div class="grid_item wd44">
								<div class="courses_item">
									<img src="<?php echo BASE_URL; ?>assets/img/courses/course-4.jpg" alt="">
									<div class="hover_text">
										<a class="cat" href="#">Free</a>
										<a href="#"><h4>Japanease Language Class</h4></a>
										<ul class="list">
							...
							<div class="grid_item wd55">
								<div class="courses_item">
									<img src="<?php echo BASE_URL; ?>assets/img/courses/course-5.jpg" alt="">
									<div class="hover_text">
										<a class="cat" href="#">Free</a>
										<a href="#"><h4>Japanease Language Class</h4></a>
										<ul class="list">
        			...
        			<div class="col-lg-3">
        				<div class="course_item">
							<img src="<?php echo BASE_URL; ?>assets/img/courses/course-3.jpg" alt="">
							<div class="hover_text">
								<a class="cat" href="#">Free</a>
								<a href="#"><h4>Japanease Language Class</h4></a>
								<ul class="list">
        	...
        	<div class="container">
        		...
        		<div class="row team_inner">
        			<div class="col-lg-3 col-sm-6">
        				<div class="team_item">
        					<div class="team_img">
        						<img class="rounded-circle" src="<?php echo BASE_URL; ?>assets/img/team/team-1.jpg" alt="">
        						<div class="hover">
        			...
        			<div class="col-lg-3 col-sm-6">
        				<div class="team_item">
        					<div class="team_img">
        						<img class="rounded-circle" src="<?php echo BASE_URL; ?>assets/img/team/team-2.jpg" alt="">
        						<div class="hover">
        							<a href="#"><i class="fa fa-facebook"></i></a>
        							<a href="#"><i class="fa fa-twitter"></i></a>
        							<a href="#"><i class="fa fa-linkedin"></i></a>
        			...
        			<div class="col-lg-3 col-sm-6">
        				<div class="team_item">
        					<div class="team_img">
        						<img class="rounded-circle" src="<?php echo BASE_URL; ?>assets/img/team/team-3.jpg" alt="">
        						<div class="hover">
        							<a href="#"><i class="fa fa-facebook"></i></a>
        							<a href="#"><i class="fa fa-twitter"></i></a>
        							<a href="#"><i class="fa fa-linkedin"></i></a>
        			...
        			<div class="col-lg-3 col-sm-6">
        				<div class="team_item">
        					<div class="team_img">
        						<img class="rounded-circle" src="<?php echo BASE_URL; ?>assets/img/team/team-4.jpg" alt="">
        						<div class="hover">
        							<a href="#"><i class="fa fa-facebook"></i></a>
        							<a href="#"><i class="fa fa-twitter"></i></a>
        							<a href="#"><i class="fa fa-linkedin"></i></a>
        		...
        		<div class="testi_slider owl-carousel">
        			<div class="item">
        				<div class="testi_item">
							<img src="<?php echo BASE_URL; ?>assets/img/testimonials/testi-3.png" alt="">
       						<h4>Fannie Rowe</h4>
       						<ul class="list">
        		...
        		<div class="row latest_blog_inner">
        			<div class="col-lg-3 col-md-6">
        				<div class="l_blog_item">
        					<img class="img-fluid" src="<?php echo BASE_URL; ?>assets/img/latest-blog/l-blog-1.jpg" alt="">
        			...
        			<div class="col-lg-3 col-md-6">
        				<div class="l_blog_item">
        					<img class="img-fluid" src="<?php echo BASE_URL; ?>assets/img/latest-blog/l-blog-2.jpg" alt="">
        					<a class="date" href="#">25 October, 2018  |  By Mark Wiens</a>
        					<a href="#"><h4>Addiction When Gambling Becomes A Problem</h4></a>
        					<p>Computers have become ubiquitous in almost every facet of our lives. At work, desk jockeys spend hours in front of their desktops, while delivery</p>
        				</div>
        			...
        			<div class="col-lg-3 col-md-6">
        				<div class="l_blog_item">
        					<img class="img-fluid" src="<?php echo BASE_URL; ?>assets/img/latest-blog/l-blog-3.jpg" alt="">
        					<a class="date" href="#">25 October, 2018  |  By Mark Wiens</a>
        					<a href="#"><h4>Addiction When Gambling Becomes A Problem</h4></a>
        					<p>Computers have become ubiquitous in almost every facet of our lives. At work, desk jockeys spend hours in front of their desktops, while delivery</p>
        				</div>
        			...
        			<div class="col-lg-3 col-md-6">
        				<div class="l_blog_item">
        					<img class="img-fluid" src="<?php echo BASE_URL; ?>assets/img/latest-blog/l-blog-4.jpg" alt="">
        					<a class="date" href="#">25 October, 2018  |  By Mark Wiens</a>
        					<a href="#"><h4>Addiction When Gambling Becomes A Problem</h4></a>
        					<p>Computers have become ubiquitous in almost every facet of our lives. At work, desk jockeys spend hours in front of their desktops, while delivery</p>
        				</div>
